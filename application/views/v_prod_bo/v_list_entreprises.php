...
<div class='row'>
    <div class='col-sm-12' style='margin-bottom: 30px'>
        <a href="<?php echo site_url('params-ajouter-entreprises');  ?>">
                        ...
                        <div class="col-sm-12">
                            ...
                            <table id='datatable-buttons' class='table datatable table-striped table-bordered'>
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            <td><?php echo $value->sigle; ?></td>
                                            <td><?php echo $value->libelle; ?></td>
                                            <td><?php echo $value->commentaires; ?></td>
                                            <td>
                                                <a href="<?php echo site_url('params-details-entreprises/' . $value->id);  ?>" class='on-default btn_edit' id='<?php echo $value->id; ?>'>
                                            ...
                                            <td class='actions' style='width: 1%; text-align: center; white-space: nowrap'>
                                                ...
                                                //{
                                                ?>
                                                <a href='<?php echo site_url('params-modifier-des-entreprises/' . $value->id);  ?>' class='on-default btn_edit' id='<?php echo $value->id; ?>'>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $(".btn-primary").click(function() {
            var id = $(".hiddenid").val();
            $.ajax({
                url: '<?php echo site_url('params-supprimer-entreprises/') ?>' + id,
                //type: "GET",
                //dataType: "HTML",
                success: function(data) {
                    window.location.replace('params-liste-des-entreprises');
                },
